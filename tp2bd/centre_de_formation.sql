...
--
-- Hôte : localhost
-- Généré le : ven. 21 nov. 2025 à 13:13
...
INSERT INTO `etudiant` (`id_etudiant`, `nom`, `prénom`, `email`) VALUES
...
CREATE TABLE `formateur` (
  ...
  `nom` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `prénom` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `spécialité` varchar(100) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `formateur` (`id_formateur`, `nom`, `prénom`, `spécialité`) VALUES
(1, 'Bernard', 'Sophie', 'Bases de données'),
(2, 'Lopez', 'Julien', 'Réseaux'),
(3, 'Renaud', 'Clara', 'Développement ');
